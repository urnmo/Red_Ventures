...
function getQuotes() {
    ...
    function forward() {
        ...
        if (current === quoteArray.length) {
            current = 0;
            document.querySelector('#author').textContent = quoteArray[0].author;
            document.querySelector('#quote').textContent = quoteArray[0].quote;
            document.querySelector('#pic').src = quoteArray[0].image;
        } else {
            current = current++;
...
// });
        ...
        //     document.querySelector('#pic').src = quoteArray[current].image;
        // }
//    for (let i = 1; i < quoteArray.length; i++) {
//             if (i > current) {
//                 current = i;
//             }
//             console.log(quoteArray[i].author);
//         };